...
import img1 from "../../../../assets/images/project/innokids.jpg";
            ...
            <div className='relative h-[100vh] grid grid-cols-1 lg:grid-cols-5 xl:grid-cols-3 gap-y-5'>
                ...
                <div className='lg:col-span-2 xl:col-span-1 flex flex-col justify-center h-full gap-y-10 lg:px-20 px-5'>
                    <div className='flex flex-col gap-3'>
                        <p>UI/UX, Web Development <BsDot className='text-red-700 inline' /> June 9, 2021</p>
                        <p className='text-[40px] font-bold uppercase'>InnoKids</p>
                        <p className='text-[17px] font-medium'>Innokids initiated its journey to focus on your kids, making them aware of life early in the age. To get rid of graduate-unemployment, we, innokids are...</p>
                    </div>
                    ...
                    <div className='grid grid-cols-3 gap-8'>
                        ...
                        <div className='border-t pt-3 border-gray-600'>
                            ...
                            <p className='text-gray-300'>MD. HUMAYUN KABIR</p>
                        </div>
                    </div>

                    <a href="https://www.innokids.org/" target="_blank" rel="noopener noreferrer" className='focus:outline-none'><div className='pb-10 flex items-center gap-2 group lg:cursor-pointer '>
